...
mixin _$DeviceInfoState {
  ...
  String? get versionCodename => throw _privateConstructorUsedError;
  ...
  int? get numberOfCores => throw _privateConstructorUsedError;
  int? get systemMemoryInMegabytes => throw _privateConstructorUsedError;
...
class _$DeviceInfoStateCopyWithImpl<$Res, $Val extends DeviceInfoState>
  ...
  $Res call({
    ...
    Object? numberOfCores = freezed,
    Object? systemMemoryInMegabytes = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      kernelVersion: freezed == kernelVersion
          ...
          : kernelVersion // ignore: cast_nullable_to_non_nullable
              as String?,
      numberOfCores: freezed == numberOfCores
          ? _value.numberOfCores
          : numberOfCores // ignore: cast_nullable_to_non_nullable
              as int?,
      systemMemoryInMegabytes: freezed == systemMemoryInMegabytes
...
class _$_DeviceInfoState implements _DeviceInfoState {
  ...
  @override
  String toString() {
    return 'DeviceInfoState(computerName: $computerName, version: $version, id: $id, versionCodename: $versionCodename, versionId: $versionId, hostName: $hostName, arch: $arch, model: $model, kernelVersion: $kernelVersion, numberOfCores: $numberOfCores, systemMemoryInMegabytes: $systemMemoryInMegabytes)';
  }
...
abstract class _DeviceInfoState implements DeviceInfoState {
  const factory _DeviceInfoState(
      ...
      final String? kernelVersion,
      final int? numberOfCores,
      final int? systemMemoryInMegabytes}) = _$_DeviceInfoState;
